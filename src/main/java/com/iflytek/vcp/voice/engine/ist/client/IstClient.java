...
import com.iflytek.vcp.voice.engine.ist.core.IstGrpc;
import com.iflytek.vcp.voice.engine.ist.core.IstOuterClass;
import com.iflytek.vcp.voice.engine.ist.exception.IstException;
...
public class IstClient implements AutoCloseable {
     ...
     * connect 连接服务的私有方法
     *
     * @throws IstException 连接异常
     */
    private void postConnect() throws IstException {
        ...
        try {
            ...
            throw new IstException("requestStreamObserver.onNext() error");
        }
    }
